...
RSpec.describe Application, type: :model do
    ...
    it 'is not valid if application PK is not unique' do
      ...
      app2 = Application.create(application_id: 1, contact_organization_id: 1, name: 'App B', date_built: 20_210_621,
    ...
    it 'is not valid if application ID is not valid' do
      app1 = Application.create(application_id: -1, contact_organization_id: 1, name: 'App 1', date_built: 20_210_621,
    ...
    #   app1 = Application.create(application_id: 1, contact_organization_id: 1, name: 'App A', date_built: 20_210_621,
    #                             github_link: 'https://gist.github.com/sseletskyy/5899820', description: 'Unique description')
    #   Application.find(application_id: 1).destroy()
    #   expect(Applications.find(application_id: 1).empty?).to be_valid
    # end
  
    it 'is not valid if contact org ID is not valid/does not exist' do
      app3 = Application.create(application_id: 2, contact_organization_id: 2, name: 'Test App 3', date_built: 20_210_621,
                                github_link: 'github.com', description: 'test app 3')
      app4 = Application.create(application_id: 4, contact_organization_id: -2, name: 'Test App 4', date_built: 20_210_621,
    ...
    it 'is not valid if name is empty' do
      app5 = Application.create(application_id: 5, contact_organization_id: 0, name: '', date_built: 20_210_621,
    ...
    it 'is not valid if githublink is empty' do
      app6 = Application.create(application_id: 6, contact_organization_id: 0, name: 'Test App 6', date_built: 20_210_621,
    ...
    it 'is not valid if description is empty' do
      app7 = Application.create(application_id: 7, contact_organization_id: 0, name: 'Test App 7', date_built: 20_210_621,
