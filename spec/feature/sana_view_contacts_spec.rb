...
RSpec.describe('Application page for student org', type: :feature) do
  ...
  scenario 'Shows correct contact info on org page' do
    org = Organization.create(organization_id: 1, name: 'A Battery', description: 'description')
...
# correct contact on org page
# correct contact on 1 application
# correct contacts with multiple applications

# contact a (on org page)
# app a = contact a
# contact b
# app b = contact b
# app c = contact a